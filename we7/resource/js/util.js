...
function getQuery(e) {
  var t = [];
  if (-1 != e.indexOf("?"))
    for (var n = e.split("?")[1].split("&"), a = 0; a < n.length; a++) n[a].split("=")[0] && unescape(n[a].split("=")[1]) && (t[a] = {
      name: n[a].split("=")[0],
...
util.url = function(e, t) {
  ...
  if (e && ((e = e.split("/"))[0] && (a += "c=" + e[0] + "&"), e[1] && (a += "a=" + e[1] + "&"),
      e[2] && (a += "do=" + e[2] + "&")), t && "object" === (void 0 === t ? "undefined" : _typeof(t)))
    for (var r in t) r && t.hasOwnProperty(params) && t[r] && (a += r + "=" + t[r] + "&");
  return a;
}, util.request = function(a) {
  require("underscore.js");
  var e, t = require("md5.js"),
    r = getApp();
  ...
  if (-1 == i.indexOf("http://") && -1 == i.indexOf("https://") && (i = util.url(i)),
    getUrlParam(i, "state") || a.data && a.data.state || !n || (i = i + "&state=we7sid-" + n), !a.data || !a.data.m) {
  ...
  wx.request((_defineProperty(e = {
    ...
    if (wx.hideNavigationBarLoading(), wx.hideLoading(), e.data.errno) {
      ...
      if (a.fail && "function" == typeof a.fail) a.fail(e);
      else if (e.data.message) {
        if (null != e.data.data && e.data.data.redirect) var t = e.data.data.redirect;
        else t = "";
  ...
  if (t)
    for (var n in t) e = e.replace(t[n], "[U+" + t[n].codePointAt(0).toString(16).toUpperCase() + "]");
  return e;
}, util.date = function() {
