var qqmapsdk, app = getApp(),
  ...
  amapFile = require("../../utils/amap-wx.js"),
  util = require("../../utils/util.js");

Page({
  data: {
    todayListArr: [{
        imgUrl: '/extend/images/6.png',
        text: '西红柿牛腩',
        id: 1
      },
      {
    ...
    categoryList: {
      pageone: [{
        name: "超市",
        src: "../../../extend/images/1.png"
      }, {
        name: "家常菜",
        src: "../../../extend/images/2.png"
      }, {
        name: "韩国料理",
        src: "../../../extend/images/3.png"
      }, {
        name: "汉堡",
        src: "../../../extend/images/4.png"
      }, {
        name: "美食",
        src: "../../../extend/images/5.png"
      }, {
        name: "面馆",
        src: "../../../extend/images/6.png"
      }, {
        name: "奶茶",
        src: "../../../extend/images/7.png"
      }, {
        name: "自选菜",
        src: "../../../extend/images/8.png"
      }],
    },
  },
  ...
  to_store_list(e) {
    console.log(e)
    var item = e.currentTarget.dataset.class_s_t
    wx.navigateTo({
      url: 'store_list?class_info=' + JSON.stringify(item)
    })
  },
  ...
  onLoad: function(t) {
    ...
    var that = this
    wx.request({
      url: 'https://www.easy-mock.com/mock/5cbaae65d5d33710e0cc47aa/quesong/quesong',
      success(e) {
        console.log(e)
        that.setData({
          easy_status: e.data.data.status
        })
      }
    })
    ...
    var s = this;
    new amapFile.AMapWX({
      key: "9426f7d2271a4e67154f7a1e861aeefe"
    }).getWeather({
      success: function(t) {
        console.log("我是高德地图的key")
      ...
      success: function(t) {
        ...
        console.log(this.data.qs_store_type)
        console.log(t.data);
  ...
  tabClick: function(t) {
    ...
    var e = this,
      ...
      console.log(e, 777)
    console.log(e.data, 8888)
    console.log(this.listarr, 999)
    console.log(a), this.setData({
      activeIndex: t.currentTarget.id
    }), "1" == a && e.setData({
      tjstorelist: e.data.tjpx.sort(function(a, b) {
  ...
  danreLoad: function() {
    ...
    var c = this,
      t = util.formatTime(new Date()).slice(11, 16);
    ...
    app.util.request({
      ...
      success: function(e) {
        ...
        })), wx.setStorageSync("nbcolor", e.data.color), getApp().sjid = e.data.id, c.setData({
          color: e.data.color
        }), app.util.request({
